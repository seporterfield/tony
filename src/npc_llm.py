...
class NPCLLM:
    ...
    def make_template(cls, persona: Persona):
        ...
        return (
            f"You are {persona.username}, an NPC in a videogame that takes place in a Discord server. "
            + f"{description}, loves chatting on Discord. You are not a helpful assistant, just this person enjoying themselves on Discord."
    ...
    def prompt(self, chat_history, a_memory):
        return ""
